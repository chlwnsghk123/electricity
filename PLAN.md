...
> 최종 갱신: 2026-04-21
> 현재 브랜치: `claude/continue-from-plan-3DuKR`
>
> **v1.05 반영사항**: 홈/모드 분리, 과목별 모드 제거, 랜덤 학습 추가, 모의고사 정식/하프 변형,
> 설정 바텀시트, 6색 태그 + 의미 라벨, 자동 태그, 메모 기능, KaTeX, 이미지 폴더 규칙, AI 멀티모달, 앱 아이콘
